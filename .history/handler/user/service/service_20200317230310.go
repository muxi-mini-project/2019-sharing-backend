...
var initOSS = func() {
	accessKey = "PgjNszg8r_8k6kjoEcA3ANuovtojlGYWDe7Koz3i"
	secretKey = "w8GagA7SLDO52OFZg_KWR2UQ-Ft3xepwhN7VRg1-"
	bucketName = "hongran"
	domainName = "q7ceuqkk7.bkt.clouddn.com"
...
func UploadImage(filename string, id uint32, r io.ReaderAt, dataLen int64) (string, error) {
	...
	cfg := storage.Config{Zone: &storage.ZoneHuazhong, UseHTTPS: false, UseCdnDomains: true}
